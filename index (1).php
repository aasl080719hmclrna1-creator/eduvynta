<?php
// Capturar cualquier output basura (warnings, notices de PHP) antes del JSON
ob_start();

// Suprimir display de errores al cliente — solo loggear
...
// Limpiar cualquier output que haya salido antes (warnings de PHP, etc.)
ob_end_clean();
ob_start();
